<footer class="flex justify-center px-4 bg-base-300 text-gray-800">
<div class="w-full 2xl:container 2xl:mx-auto py-6">
    <h1 class="text-lg text-center lg:text-xl mt-20 text-gray-600">
        Subscribe and never miss out on news, updates, and more.
    </h1>
    ...
    <div class="flex justify-center mt-6 mb-20">
        <div class="bg-white border rounded-md focus-within:ring focus-within:border-blue-500">
            <div class="flex flex-wrap justify-between md:flex-row p-1">
                <input type="email" class="p-2 m-1 w-full md:w-[300px] text-sm text-gray-700 appearance-none focus:outline-none focus:placeholder-transparent" placeholder="Enter your email" aria-label="Enter your email">
                <button class="btn normal-case w-full md:w-auto no-animation">Subscribe</button>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col items-center justify-between mt-6 md:flex-row">
        ...
        <div class="flex mt-4 -mx-2 md:m-0">
    ...
    <hr class="h-px mt-6 border-gray-300">

    <div class="mt-6">
        <p class="text-center text-gray-800">Copyright © 2022 - All right reserved</p>
    </div>
</div>
</footer>